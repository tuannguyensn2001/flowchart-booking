...
const Dialog = (props) => {
    ...
    return (
        <div>
            ...
            <Modal style={{top: 0}} title={checkTitle()} visible={props.show}
                   onOk={onOk}
                   onCancel={onCancel}
            >
                ...
                <FormGroup>
                    ...
                    <InputNumber
                        ...
                        onChange={(event) => onChangeInput('order', event)}
                        value={format.order()}/>
                </FormGroup>
                ...
                <FormGroup>
                    ...
                    <TextArea
                        ...
                        onChange={(event) => onChangeInput('description', event.target.value)}
                        value={format.description()}/>
                </FormGroup>

                <FormGroup>
                    <label htmlFor="">Chọn nhập liệu thêm</label>
                    <Radio.Group value={isMore} onChange={event => setIsMore(event.target.value)}>
                        <Radio value={false}>Không</Radio>
                        <Radio value={true}>Có</Radio>
                    </Radio.Group>

                    {isMore && <Select
                        placeholder="Chọn nhập liệu thêm"
                        onChange={value => onChangeInput('category_input_id', value)}
                        value={format.more()}
                    >
                        {render.more()}
                    </Select>}
